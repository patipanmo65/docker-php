...
if (isset($_POST['submit'])) {
    ...
    if (!empty($_FILES['pdf_file']['name'])) {
        ...
        $sqlSelect = "SELECT pdf_file FROM medical_research WHERE id=?";
        ...
        if (move_uploaded_file($pdfTempName, $pdfFilePath)) {
            ...
            $sqlSelectImage = "SELECT image FROM medical_research WHERE id=?";
            ...
            if (move_uploaded_file($imageTempName, $imageFilePath)) {
                ...
                $sql = "UPDATE medical_research SET title=?, content=?, pdf_file=?, image=? WHERE id=?";
        ...
        $sql = "UPDATE medical_research SET title=?, content=? WHERE id=?";
        $stmt = mysqli_prepare($conn, $sql);

                    ...
                    <div class="col-md-10">
                        ...
                        <form class="row gy-4" action="php/update.php" method="POST" enctype="multipart/form-data">
                            <div class="col-md-12">
                                ...
                                <input type="text" class="form-control" id="title" name="title" placeholder="ชื่อเรื่อง" value="<?php echo $row['title']; ?>" required>
                            </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <textarea type="text" class="form-control" id="description" name="description" placeholder="ข้อความ" value="<?php echo $row['description']; ?>" required></textarea>
                            </div>

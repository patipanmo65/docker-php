                    ...
                    <div class="col-md-10">
                        ...
                        <form class="row gy-4" action="php/update.php" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="email" class="form-control" id="content" name="email" placeholder="อีเมลล์"
                                    value="<?php echo $row['email']; ?>" required>
                            </div>
                            <div class="col-md-12">
                                <label for="name" class="form-label">ข้อความ</label>
                                <input type="text" class="form-control" id="message" name="message"
                                    placeholder="ข้อความ" value="<?php echo $row['message']; ?>" required>
                            </div>

...
<head>
    ...
    <title>จัดการข่าว2 | Hospital</title>
    <!-- Favicons -->
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <a href="form-create.php" class="btn btn-primary float-right">เพิ่มข่าว</a>
                                </div>
                                <div class="card-body">
                                        ...
                                        <tbody>
                                            ...
                                            if ($result->num_rows > 0) {
                                                ...
                                                while ($row = $result->fetch_assoc()) {
                                                    echo "<tr>";
                                                    echo "<td>" . $index++ . "</td>";
                                                    echo "<td><img src='" . $row["image"] . "' class='img-fluid' width='100'></td>";
                                                    echo "<td>" . $row["title"] . "</td>";
                                                    echo "<td>" . $row["content"] . "</td>";
                                                    echo "<td>";
                                                    echo "<a href='form-edit.php?id=" . $row['id'] . "' class='btn btn-primary'>แก้ไข</a>";
                                                    echo "<a href='delete.php?id=" . $row['id'] . "' class='btn btn-danger' onclick=\"return confirm('คุณแน่ใจหรือไม่ว่าต้องการลบข่าวนี้?')\">ลบ</a>";
                                                    echo "</td>";
                                                    echo "</tr>";
                                                }
                                            } else {

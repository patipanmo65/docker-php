                                            ...
                                            <div class="card-body">
                                                <div class="form-row">
                                                    <div class="form-group col-md-12">
                                                        ...
                                                        <input type="text" class="form-control" name="p_name" id="p_name" placeholder="หัวข้อเรื่องใหม่" value="<?php echo $row['title']; ?>">
                                                    </div>
                                                    <div class="form-group col-md-12">
                                                        <label for="price">หัวข้อย่อย</label>
                                                        <input type="text" class="form-control" name="price" id="price" placeholder="หัวข้อย่อย" value="<?php echo $row['content']; ?>">
                                                    </div>
